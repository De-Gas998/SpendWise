...
void _expenseSerialize(
  ...
  writer.writeDouble(offsets[0], object.account);
...
Expense _expenseDeserialize(
  ...
  final object = Expense(
    account: reader.readDouble(offsets[0]),
...
extension ExpenseQueryFilter
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> accountEqualTo(
    double value, {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> accountGreaterThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> accountLessThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> accountBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ExpenseQuerySortBy on QueryBuilder<Expense, Expense, QSortBy> {
  QueryBuilder<Expense, Expense, QAfterSortBy> sortByAccount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'account', Sort.asc);
    });
  }

  QueryBuilder<Expense, Expense, QAfterSortBy> sortByAccountDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ExpenseQuerySortThenBy
  ...
  QueryBuilder<Expense, Expense, QAfterSortBy> thenByAccount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'account', Sort.asc);
    });
  }

  QueryBuilder<Expense, Expense, QAfterSortBy> thenByAccountDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'account', Sort.desc);
    });
  }
...
extension ExpenseQueryWhereDistinct
  ...
  QueryBuilder<Expense, Expense, QDistinct> distinctByAccount() {
    return QueryBuilder.apply(this, (query) {
...
extension ExpenseQueryProperty
  ...
  QueryBuilder<Expense, double, QQueryOperations> accountProperty() {
    return QueryBuilder.apply(this, (query) {
